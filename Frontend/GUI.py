...
Assistantsname = env_vars.get("Assistantname")
...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        movie = QMovie(GraphicsDirectoryPath('ARIA.gif'))
        max_gif_size_W = 480
        max_gif_size_H = 270
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        title_label = QLabel(f"{Assistantsname.capitalize()} AI")
