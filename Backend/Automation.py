...
# Function to open an applicaction or a relevant webpage.
...
async def TranslateAndExecute(commands: list[str]):
    ...
    results =await asyncio.gather(*funcs)   # Executes all task concurrently.
...
if __name__ == "__main__":
    asyncio.run(Automation(["open microsoft edge","open settings","content write a letter for sick leave to principal","play tum tak", "open telegram","open facebook"]))